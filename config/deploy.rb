...
set :application, "foroldy"
set :keep_releases, 5
set :repository, "git@github.com:itbakery/foroldy.git"
set :user, "deploy"
set :scm, :git
set :run_method, :run
...
set :rvm_ruby_string, "ruby-1.9.3-p392@foroldy"
#set :rvm_ruby_string, "ruby-1.9.3-p392"
#set :rvm_ruby_string, ENV['GEM_HOME'].gsub(/.*\//,"")
#set :bundle_cmd , "/home/deploy/.rvm/gems/ruby-1.9.3-p194@foroldy/bin/bundle"
